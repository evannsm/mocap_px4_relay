...
public:
    FullStateRelay() : Node("full_state_relay_node")
    {
        ...
        full_state_pub_ = create_publisher<px4_msgs::msg::FullState>(
...
private:
    ...
    rclcpp::Publisher<px4_msgs::msg::FullState>::SharedPtr full_state_pub_;
    ...
    // --- State & gating params ---
    px4_msgs::msg::FullState full_state_msg_{};
